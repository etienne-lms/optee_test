...
#define RSA_PUB_ATTR_MODULUS            5
#define RSA_PUB_ATTR_PUBLIC_EXPONENT    6
#define RSA_PUB_ATTR_COUNT              7
...
#define RSA_PRIV_ATTR_MODULUS           5
#define RSA_PRIV_ATTR_PUBLIC_EXPONENT   6
#define RSA_PRIV_ATTR_PRIVATE_EXPONENT  7
#define RSA_PRIV_ATTR_PRIME_1           8
#define RSA_PRIV_ATTR_PRIME_2           9
#define RSA_PRIV_ATTR_EXPONENT_1        10
#define RSA_PRIV_ATTR_EXPONENT_2        11
#define RSA_PRIV_ATTR_COEFFICIENT       12
#define RSA_PRIV_ATTR_COUNT             13
